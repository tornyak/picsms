...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	/**
	 * Adds an action button to the compatibility action bar, using menu information from a {@link android.view.MenuItem}. If the menu item ID is <code>menu_refresh</code>, the menu item's
	 * state can be changed to show a loading spinner using {@link com.example.android.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
	 */
